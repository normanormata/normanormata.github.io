...
title: "Nahum"
layout: "scripture"
description: "Every place the Westminster Standards and the Heidelberg Catechism cite Nahum in their scripture proofs — 5 references to 3 passages."
exclude_from_search: true
---

5 references to 3 passages of Nahum, drawn from the scripture proofs of the [Westminster Standards]({{ site.baseurl }}/pages/wcf/) and the [Heidelberg Catechism]({{ site.baseurl }}/pages/heidelberg/). Every reference links to the section that cites the passage.
...
<a href="{{ site.baseurl }}/scripture/micah/">← Micah</a>
<a href="{{ site.baseurl }}/scripture/">All books</a>
<a href="{{ site.baseurl }}/scripture/habakkuk/">Habakkuk →</a>
</nav>
